####################################################################
#Project: Analysis of the U.S. College Scorecards
#Author: Alexey Silin
...
#determining the number of distinct colleges
...
str(scores) #to see other features
...
#Determining proportion of private and public schools
...
table(scores$ownership2)      #shows the numbers of private and public schools
...
#Estimating the cost of tuition in five most populous states
#According to Wikipedia (https://simple.wikipedia.org/wiki/List_of_U.S._states_by_population)
...
# Determining the relationship between spending per student and 10-year earnings
...
# Estimating the earing per cost of tuition
...
#Measuring the Racial Diversity
...
#Comparing the UC Davis with Other Schools
